Feature: user adds friends as lovers
  ...
  You ignored a request from <Matt Di Pasquale>.
  TODO: When you ignore a Facebook app request, does it delete it? I assume so.
  ...
  # # TODO: Implement send request & reject request for front-end UI.
  ...
  #   When I reject a "<rid>" request from user "<uid>"
  #   Then I should have "<recv>" received requests
  #   And the response code should be "<code>"
  #
  #   Scenarios: successful reject
  #     | rid | uid | recv | code |
  #     | 2   | 12  | 1    | 1    |
  #     | 1   | 15  | 2    | 1    |
  #
  #   Scenarios: no request to reject
  #     | rid | uid | recv | code |
  #     | 0   | 14  | 2    | 0    |
  #
