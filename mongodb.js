...
db.users.find({fbId:514417}, {relationships:true}); // just get user's relationships

db.users.update( { fbId : 5514417 }, { $addToSet : { relationships : { rid : 3, uid : 124322 } } });
db.users.update( { fbId : 5514417 }, { $addToSet : { relationships : { rid : 3, uid : 57484 } } });
